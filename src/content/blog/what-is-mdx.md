...
Now, why would you want to use MDX for a blog? Well, the main benefit is simplicity. Writing in Markdown is _so_ much easier than writing JSX for content-heavy pages. Compare these two:
...
I will say though, setting up MDX took a bit of configuration. You need to set up the MDX loader/plugin for your build tool, configure any rehype or remark plugins you want to use (for things like syntax highlighting or auto-linking headings), and wire up the components. But once it's set up, writing content becomes _so_ much smoother.
