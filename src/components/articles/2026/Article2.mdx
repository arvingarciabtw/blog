...
What pleasantly surprised me the most is that Next.js uses *file-system routing*. Essentially, the routes in your application are determined by your directory structure! This is the first time I've seen this, so I'm not sure if there are other frameworks that adopt this paradigm. 
