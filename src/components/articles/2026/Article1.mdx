...
1. Build at least three projects that solves a problem I have.
2. Be self-sufficient without AI.
3. Get a job after graduating.

I could make these goals more descriptive by using the [SMART framework](https://www.atlassian.com/blog/productivity/how-to-write-smart-goals), but I'll leave it as is for the sake of brevity.
...
For instance, near the end of last year, I discovered this concept called [spaced repetition](https://ncase.me/remember/). Essentially, it's a way to retain information, by writing them down in flashcards. The frequency of when you practice with these flashcards is spaced out, depending on how often you've got them right.
...
And so I've searched a lot about what app I could use to practice, and many people suggest [Anki](https://apps.ankiweb.net/). I've tried it for a few weeks, and it... works just fine. Though, I have two pain points with it: 
